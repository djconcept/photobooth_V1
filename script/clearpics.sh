...
sudo mount /dev/sda1 /mnt/disk_usb/
sudo mkdir /mnt/disk_usb/$STR

sudo cp -r /home/pi/drive_ext/pics /mnt/disk_usb/$STR
sudo cp -r /home/pi/drive_ext/backup /mnt/disk_usb/$STR
sudo cp -r /home/pi/drive_ext/gif /mnt/disk_usb/$STR
sudo cp -r /home/pi/drive_ext/pics_w /mnt/disk_usb/$STR
sudo cp -r /home/pi/drive_ext/screen /mnt/disk_usb/$STR
sudo cp -r /home/pi/drive_ext/mosaic /mnt/disk_usb/$STR
